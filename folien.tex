...
\frame[t]{\frametitle{Verschiedenes}
  \begin{itemize}
    ...
    \item \ldots statt ... (\texttt{\textbackslash ldots})
...
\frame[t]{\frametitle{Praktische Tipps}
  \begin{itemize}
    ...
    \item Mit tabbing-Umgebung gleiches unter gleichem ausrichten.
  \end{itemize}
}
...
\imageslide{0.45}{bad-typography}
...
\frame[t]{\frametitle{Bildquellen}
  \tiny
  \begin{itemize}
    \item \url{http://37.media.tumblr.com/tumblr_ma515afNSb1qcq8vao1_400.png}
